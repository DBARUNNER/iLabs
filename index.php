...
<!-- THIS WEBSITE HAS BEEN DESIGN AND DEVELOPED BY ABDULLAH RAHIMEE AND ALL RIGHTS IS RESERVED TO HIM -->
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav" >
						...
						<li>
							<a class="page-scroll" href="#ilab" style="height:52px;">What’s iLabs</a>
						</li>
						<li>
					...
					<ul class="pull-right nav navbar-nav">
			          ...
			          <li style="background-color:#4099FF;"><a href="https://twitter.com/iLabsAf" target="_blank"><i id="social" class="fa fa-twitter-square fa-2x "></i></a></li>
