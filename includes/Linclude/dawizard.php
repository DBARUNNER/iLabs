												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group left-inner-addon required-field-block">
																...
																<span class="pull-left text-left" id="error1d" lang="<?php echo $language1; ?>" style="color:red"></span>
														...
														<div class="form-group left-inner-addon required-field-block">
															<span class="fa fa-user"></span>
															<span class="pull-left text-left" id="error2d" lang="<?php echo $language1; ?>" style="color:red"></span>
														...
														<div class="form-group left-inner-addon required-field-block">
															...
															<span class="pull-left" id="error3d" lang="<?php echo $language1; ?>" style="color:red"></span>
													...
													<div class="col-md-6">
														...
														<div class="form-group left-inner-addon required-field-block">
															...
															<span class="pull-left" id="error4d" lang="<?php echo $language1; ?>" style="color:red"></span>
														...
														<div class="form-group left-inner-addon required-field-block">
															...
															<span class="pull-left" id="error5d" lang="<?php echo $language1; ?>" style="color:red"></span>
														...
														<div class="form-group left-inner-addon required-field-block">
															...
															<span class="pull-left" id="error6d" lang="<?php echo $language1; ?>" style="color:red"></span>
													...
													<div class="separator-2"></div>
														...
														<div class="form-group col-md-10 col-md-offset-1">
															...
															<span class="" id="error7d" lang="<?php echo $language1; ?>" style="color:red"></span>
														</div>
