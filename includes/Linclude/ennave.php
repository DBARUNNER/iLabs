<div class="row" style="margin:0;">
				<div class="col-md-12" >
					...
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a style="line-height:0px;font-size:12px;display:inline;top:4px;" class="page-scroll"><i class="fa"></i>		Connect with us! &nbsp;<i class="fa fa-phone"></i>&nbsp;		+93 788 161 862‏ &nbsp;	</i>&nbsp;<i class="fa fa-envelope"></i>		ilabs@technation.af</a>
							<a style="line-height:0px;font-size:12px; display:inline;top:4px;" href="index.php?lang=<?php echo $lk1; ?>"><?php echo $lang1; ?></a><a style="line-height:0px; display:inline;top:4px;">|</a><li><a style="line-height:0px;font-size:12px;display:inline;top:4px;"  href="index.php?lang=<?php echo $lk2; ?>"><?php echo $lang2; ?></a>
						</li>	
					</ul>
				</div>
			</div>
