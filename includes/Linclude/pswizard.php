	<!--      Wizard container        -->
							<div class="wizard-container" id="re-wizard">
								...
								<div class="card wizard-card ct-wizard-green" id="wizard">
									...
									<ul>
										<li>
											<a href="#personal" data-toggle="tab"><?php echo $occupation; ?></a>
										</li>
										<li>
											<a href="#occupation" data-toggle="tab"><?php echo $Participate10; ?></a>
										</li>
									</ul>
												...
												<div class="row">
													...
													<div class="col-md-6">
														...
														<div class="form-group left-inner-addon required-field-block">
															...
															<span class="pull-left" id="error4p" lang="<?php echo $language1; ?>" style="color:red"></span>
														...
														<!-- 	<span class="fa fa-tasks"></span> -->
															<span class="pull-left" id="error5p" lang="<?php echo $language1; ?>" style="color:red"></span>
														...
														<!-- 	<span class="fa fa-globe"></span> -->
															<span class="pull-left" id="error6p" lang="<?php echo $language1; ?>" style="color:red"></span>
													...
													<div class="col-md-6">
														<div class="form-group left-inner-addon required-field-block">
																...
																<span class="pull-left text-left" id="error1p" lang="<?php echo $language1; ?>" style="color:red"></span>
														...
														<div class="form-group left-inner-addon required-field-block">
															...
															<span class="pull-left text-left" id="error2p" lang="<?php echo $language1; ?>" style="color:red"></span>
														...
														<!-- 	<span class="fa fa-mobile-phone"></span> -->
															<span class="pull-left" id="error3p" lang="<?php echo $language1; ?>" style="color:red"></span>
													...
													<div class="separator-2"></div>
														...
														<div class="form-group col-md-10 col-md-offset-1">
															...
															<span class="" id="error7p" lang="<?php echo $language1; ?>" style="color:red"></span>
														</div>
